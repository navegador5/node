...
const l2_repl = require('internal/repl');
...
const ndfunc = require("html/tree/ndfunc");
const ndcls = require("html/tree/ndcls");
const html_node = require("html/node/node");
...
function enable_console_server(rl_terminal,useGlobal,port,prompt=">>> ") {
        ...
        repl.start(
           {
               ...
               useGlobal:useGlobal,
               useColors:true,
               terminal:true,  //socket false可防止多重输出
               rl_terminal:rl_terminal,
