...
function setupTaskQueueAndTimers() {
  ...
  const js = setupTaskQueue();
  //default queue
  process.nextTick = js.nextTick;
  process._tickCallback = js.runNextTicks;
  process.js = js;
  //customer queue
  ...
  const { processImmediate, processTimers } = getTimerCallbacks(js.runNextTicks);
