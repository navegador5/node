...
function listenForRejections() {
  ...
  setPromiseRejectCallback((type, promise, reason)=>{})
}
...
module.exports = {
  //const
  kHasRejectionToWarn,
  kIgnoreUnhandledRejections,
  kAlwaysWarnUnhandledRejections,
  kStrictUnhandledRejections,
  kThrowUnhandledRejections,
  kWarnWithErrorCodeUnhandledRejections,
  unhandledRejectionErrName,
  //
  ...
  unhandledRejection,
  handledRejection,
  emitUnhandledRejectionWarning,
  getErrorWithoutStack,
