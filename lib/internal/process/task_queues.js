...
const __console__ = ['resume_','afterWriteTick','onpause','maybeReadMore_']
...
function processTicksAndRejections() {
  ...
  do {
    while (tock = queue.shift()) {
      // 只处理console 的write-tick
      if(!__console__.includes(tock.callback.name)){
          console.log(tock)
          break;
      }
      //
    ...
    //runMicrotasks();  ------move for manual run micro task
